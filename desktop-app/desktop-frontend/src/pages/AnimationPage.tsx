...
const AnimationPage: React.FC = () => {
  ...
  const createAnimation = async () => {
    ...
    try {
      ...
      const result = await apiService.createAnimation(selectedImage, animationType);

      clearInterval(interval);
      setProgress(100);

      // Use the result animation URL
      setAnimationResult(apiService.getLocalFileUrl('/uploads/animation-placeholder.gif'));
      console.log('Animation created:', result);

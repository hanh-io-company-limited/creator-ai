  ...
  const createVideo = async () => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:3001/api/video/create', {
        ...
        body: JSON.stringify({
          sourceId: selectedAnimation,
          audioType: audioType === 0 ? 'tts' : audioType === 1 ? 'upload' : 'music',
      ...
      setVideoResult('https://via.placeholder.com/800x450/4285f4/ffffff?text=Video+Result');
